...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full h-[500px] bg-secondary p-0">
      ...
      <div className=" md:container flex justify-between items-center relative md:absolute top-0 left-0 md:left-1/2 translate-x-0 md:-translate-x-1/2 h-full z-10">
        ...
        <div className="w-full sm:w-[400px] bg-gray-50 sm:rounded-lg px-5 py-3 pb-5 sm:py-6">
						<h3 className="text-center mb-4 font-medium text-secondary">Giriş yap veya kayıt ol</h3>
          ...
          <button className="h-12 rounded-lg transition-colors cursor-pointer bg-yellow-300 text-secondary text-sm font-medium hover:bg-secondary hover:text-yellow-300">
